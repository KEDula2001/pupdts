          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 fw-bold"><?php echo count($count_incomplete_uploads); ?></div>
              </div>
                <div class="col-auto">
                    ...
                    <?php if ($res['upload_status'] == 'incomplete'): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url('admission/student-admission-file/'.$student['user_id']); ?>" class="btn btn-edit text-dark btn-sm" data-toggle="tooltip" title="View"><i class="fas fa-file-image"></i>Gallery</a>
                        </td>
