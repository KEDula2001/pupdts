  ...
  <div class="row">
    ...
    <div class="col-6">
      <div class="card" style="border-color: gray;border-width: 2px;">
        ...
        <div class="row">
          <div class="col">
            <form action="<?php echo base_url('admissionregistrar/sendnotifystudents1/'.$studentadmission_details['studID']); ?>" method="post">
            <div class="row">
                <div class="col">
                <label><strong>SAR Form/PUPCET/CAEPUP Result:</strong></label> <br>
                    <div style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (SAR FORM)" name="not_submitted_sarform" >
                      <label for="not_submitted_sarform"> Not Submitted <small style="display: none">SAR FORM</small></label><br>
                      </div>
                    ...
                    <label><strong>F137:</strong></label> <br>
                      ...
                      <input type="checkbox" value="Not Submitted (F137)" name="not_submitted_f137" >
                      <label for="not_submitted_f137"> Not Submitted </label><br>
            ...
            <div class="row">
              <div class="col">
                    ...
                    <div style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (Grade 10 CARD)" name="not_submitted_grade10" >
                      <label for="not_submitted_grade10"> Not Submitted </label><br>
                    ...
                    <div style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (Grade 11 CARD)" name="not_submitted_grade11" >
                      <label for="not_submitted_grade11"> Not Submitted </label><br>
            ...
            <div class="row">
              <div class="col">
                    ...
                    <div class="col" style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (Grade 12 CARD)" name="not_submitted_grade12" >
                      <label for="not_submitted_grade12"> Not Submitted </label><br>
                    ...
                    <div class="col" style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (PSA/NSO)" name="not_submitted_psa" >
                      <label for="not_submitted_psa"> Not Submitted </label><br>
            ...
            <div class="row">
              <div class="col">
                    ...
                    <div class="col" style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (GOOD MORAL)" name="not_submitted_goodmoral" >
                      <label for="not_submitted_goodmoral"> Not Submitted </label><br>
                    ...
                    <div class="col" style="margin-left: 50px">
                      ...
                      <input type="checkbox" value="Not Submitted (MEDICAL CERTIFICATE)" name="not_submitted_medcert" >
                      <label for="not_submitted_medcert"> Not Submitted </label><br>
            ...
            <div class="row">
              ...
              <div class="col" style="margin-left: 50px">
                    ...
                    <label for = "twobytwo"> Not submitted </label>
