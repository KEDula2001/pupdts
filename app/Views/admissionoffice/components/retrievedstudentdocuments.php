                            ...
                            <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <form action="<?php echo base_url('admission/insert-admission/'.$student['user_id']); ?>" method="post" autocomplete="off">
                                  ...
                                  <div class="row">
                                    <div class="col">
                                        <label><strong>Admission Requirements:</strong></label><br>
                                        ...
                                        <label><strong>Other Documents:</strong></label><br>
                                    ...
                                    <div class="col">
                                       <label><strong>Graduation Requirements:</strong></label><br>
