...
class Dashboards extends BaseController {
  ...
  public function index(){
    if($_SESSION['role'] == "Admission"){
        ...
        $data['claim_count'] = count($this->requestDetailModel->getDetails(['request_details.status' => 'c', 'requests.status' => 'o', 'request_details.document_id' => 6]));
        ...
        $data['request_count'] = count($this->requestDetailModel->getDetails(['requests.status' => 'p', 'request_details.document_id' => 27]));
        ...
        $data['completed_count'] = count($this->requestDetailModel->getDetails(['request_details.status' => 'c', 'requests.status' => 'o', 'request_details.document_id' => 27]));
        $data['view'] = 'Modules\SystemSettings\Views\dashboards\index';
    }
        ...
        $data['request_count'] = count($this->requestDetailModel->getDetails(['requests.status' => 'p', 'request_details.document_id' => 26]));
        $data['detail_count'] = count($this->requestDetailModel->getDetails(['request_details.status' => 'p', 'requests.status' => 'o', 'request_details.document_id' => 26]));
        $data['claim_count'] = count($this->requestDetailModel->getDetails(['request_details.status' => 'r', 'requests.status' => 'o', 'request_details.document_id' => 26]));
        $data['completed_count'] = count($this->requestDetailModel->getDetails(['request_details.status' => 'c', 'requests.status' => 'o', 'request_details.document_id' => 26]));
        $data['view'] = 'Modules\SystemSettings\Views\dashboards\index';
    }
